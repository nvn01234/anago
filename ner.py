...
train_paths = ["data/train/%s.muc" % s for s in ["Doi_song", "Giai_tri", "KH-CN", "Kinh_te", "Phap_luat","The_gioi", "The_thao", "Van_hoa","Xa_hoi"]]
valid_path = "data/dev/Giao_duc.muc"
test_path = "data/test/Giao_duc.muc"
