...
train_paths = ["data/train/%s.muc" % s for s in ["Doi_song", "Giai_tri", "Giao_duc", "KH-CN", "Phap_luat","The_gioi", "The_thao", "Van_hoa","Xa_hoi"]]
valid_path = "data/dev/Kinh_te.muc"
test_path = "data/test/Kinh_te.muc"
