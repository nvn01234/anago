...
train_paths = ["data/train/%s.muc" % s for s in ["Doi_song", "Giai_tri", "Giao_duc", "KH-CN", "Kinh_te","Phap_luat", "The_gioi", "The_thao","Van_hoa"]]
valid_path = "data/dev/Xa_hoi.muc"
test_path = "data/test/Xa_hoi.muc"
