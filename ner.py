...
train_paths = ["data/train/%s.muc" % s for s in ["Doi_song", "Giai_tri", "Giao_duc", "Kinh_te", "Phap_luat","The_gioi", "The_thao", "Van_hoa","Xa_hoi"]]
valid_path = "data/dev/KH-CN.muc"
test_path = "data/test/KH-CN.muc"
