...
train_paths = ["data/train/%s.muc" % s for s in ["Doi_song", "Giao_duc", "KH-CN", "Kinh_te", "Phap_luat","The_gioi", "The_thao", "Van_hoa","Xa_hoi"]]
valid_path = "data/dev/Giai_tri.muc"
test_path = "data/test/Giai_tri.muc"
