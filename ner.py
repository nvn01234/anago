...
train_paths = ["data/train/%s.muc" % s for s in ["Doi_song", "Giai_tri", "Giao_duc", "KH-CN", "Kinh_te","Phap_luat", "The_gioi", "Van_hoa","Xa_hoi"]]
valid_path = "data/dev/The_thao.muc"
test_path = "data/test/The_thao.muc"
